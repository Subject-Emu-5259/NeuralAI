...
Chapter 4 of [Web Browser Engineering](https://browser.engineering/index.html "Table of Contents").
[<](https://browser.engineering/text.html "Previous chapter")
[>](https://browser.engineering/layout.html "Next chapter")
...
* [A Tree of
  Nodes](https://browser.engineering/html.html#a-tree-of-nodes)
* [Constructing the Tree](https://browser.engineering/html.html#constructing-the-tree)
* [Debugging
  a Parser](https://browser.engineering/html.html#debugging-a-parser)
* [Self-closing
  Tags](https://browser.engineering/html.html#self-closing-tags)
* [Using
  the Node Tree](https://browser.engineering/html.html#using-the-node-tree)
* [Handling Author Errors](https://browser.engineering/html.html#handling-author-errors)
* [Summary](https://browser.engineering/html.html#summary)
* [Outline](https://browser.engineering/html.html#outline)
* [Exercises](https://browser.engineering/html.html#exercises)
...
Object Model](https://en.wikipedia.org/wiki/Document_Object_Model). I’ll keep calling it the HTML tree for
...
![Figure 1: An HTML document, showing tags, text, and the nesting structure.](https://browser.engineering/im/html-syntax.png)
...
![Figure 2: The finished and unfinished nodes while parsing some HTML.](https://browser.engineering/im/html-lr-2.gif)

Figure 2: The finished and unfinished
nodes while parsing some HTML.
...
predecessor, [SGML](https://en.wikipedia.org/wiki/Standard_Generalized_Markup_Language),
traces back to [RUNOFF](https://en.wikipedia.org/wiki/TYPSET_and_RUNOFF) and is
a sibling to [troff](https://troff.org), now used for Linux
manual pages. The [committee](https://www.iso.org/committee/45374.html) that
...
idea](https://developer.mozilla.org/en-US/docs/Web/API/Document/write). An implementation of `document.write` must have the
...
parsing](https://developer.mozilla.org/en-US/docs/Glossary/speculative_parsing) to start loading additional resources even before parsing is
done.
...
Try this out on [the
web page](https://browser.engineering/html.html) corresponding to this chapter, parsing the HTML source code
...
This special tag, called a [doctype](https://html.spec.whatwg.org/multipage/syntax.html#the-doctype),
...
Browsers do use the absence of a document type declaration to [identify](https://developer.mozilla.org/en-US/docs/Web/HTML/Quirks_Mode_and_Standards_Mode)
very old, pre-SGML versions of HTML,There’s also this crazy thing called “[almost standards](https://hsivonen.fi/doctype/)” or “limited
...
list](https://html.spec.whatwg.org/multipage/syntax.html#void-elements) of these self-closing tags (the specification calls them “void”
tags):A lot of these
...
names, so I case-fold them.Lower-casing text is the [wrong way](https://www.b-list.org/weblog/2018/nov/26/case/) to
...
`<br/>`, became fashionable when [XHTML](https://www.w3.org/TR/xhtml1/) looked like it might
replace HTML, and old-timers like me never broke the habit. But unlike
in [XML](https://www.w3.org/TR/xml/#sec-starttags), in HTML
...
standard*](https://html.spec.whatwg.org/).It is
...
have to handle broken, confusing, `head`less HTML. In fact,
...
years in the early 2000s the W3C tried to [do away with it](https://www.w3.org/TR/xhtml1/). They
failed.
...
human error, but one of its nicer features is *implicit* tags.
...
Here, `HEAD_TAGS` lists the tags that you’re supposed to
...
standard](https://html.spec.whatwg.org/multipage/parsing.html). Of course, sometimes these rules “guess” wrong—but as so
often happens on the web, it’s more important that every browser does
the *same* thing, rather than each trying to guess what the
*right* thing is.

And now for the payoff! Figure 3 shows a screenshot of [this book’s website](https://browser.engineering/), loaded in
our own browser.To be
fair, it actually looks about the same with the Chapter 3
browser.

![Figure 3: Screenshot of http://browser.engineering/ viewed in this chapter’s version of the browser.](https://browser.engineering/examples/example4-browserengineering-screenshot.png)
...
states](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-afterbody) guarantee something stricter than that: every HTML document
...
[Close](https://browser.engineering/html.html)
...
tab, `\v`, `\r`, slash, or greater than sign](https://html.spec.whatwg.org/multipage/parsing.html#script-data-end-tag-name-state).
...
`view-source` protocol as in [Exercise 1-5](https://browser.engineering/http.html#exercises), but make it
