...
Chapter 1 of [Web Browser Engineering](https://browser.engineering/index.html "Table of Contents").
[<](https://browser.engineering/history.html "Previous chapter")
[>](https://browser.engineering/graphics.html "Next chapter")
...
* [Connecting to a Server](https://browser.engineering/http.html#connecting-to-a-server)
* [Requesting Information](https://browser.engineering/http.html#requesting-information)
* [The
  Server’s Response](https://browser.engineering/http.html#the-servers-response)
* [Telnet in
  Python](https://browser.engineering/http.html#telnet-in-python)
* [Request and Response](https://browser.engineering/http.html#request-and-response)
* [Displaying the HTML](https://browser.engineering/http.html#displaying-the-html)
* [Encrypted Connections](https://browser.engineering/http.html#encrypted-connections)
* [Summary](https://browser.engineering/http.html#summary)
* [Outline](https://browser.engineering/http.html#outline)
* [Exercises](https://browser.engineering/http.html#exercises)
...
DNS lookup tool like [nslookup.io](https://nslookup.io) or
...
series of *routers*Or a switch, or an access point; there are a lot of
...
and Features / Turn Windows features on or off](https://www.lifewire.com/what-is-telnet-2626026) in the Control Panel;
...
The URL syntax is defined in [RFC 3986](https://tools.ietf.org/html/rfc3986), whose first
...
of the web in his [Ph.D. thesis](https://ics.uci.edu/~fielding/pubs/dissertation/fielding_dissertation_2up.pdf),
...
principles, though there does seem to be [some confusion](https://twobithistory.org/2020/06/28/rest.html)
about it.
...
tells the host that the browser speaks version 1.0 of [HTTP](https://developer.mozilla.org/en-US/docs/Web/HTTP). There
are several versions of HTTP ([0.9,
1.0, 1.1, 2.0, and 3.0](https://medium.com/platform-engineer/evolution-of-http-69cfe6531ba0)). The HTTP 1.1 standard adds a variety of
...
HTTP/1.0 is standardized in [RFC 1945](https://tools.ietf.org/html/rfc1945), and HTTP/1.1 in
[RFC 2616](https://tools.ietf.org/html/rfc2616). HTTP was
...
different codes [on
Wikipedia](https://en.wikipedia.org/wiki/List_of_HTTP_status_codes), and new ones do get added here and there.
...
After the headers there is a blank line followed by a bunch of [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML) code.
...
![Figure 4: An HTTP request and response pair are how a web browser gets web pages from a web server.](https://browser.engineering/im/http-request-2.gif)

Figure 4: An HTTP request and response
pair are how a web browser gets web pages from a web
server.

Wikipedia has nice lists of HTTP [headers](https://en.wikipedia.org/wiki/List_of_HTTP_header_fields)
and [response
codes](https://en.wikipedia.org/wiki/List_of_HTTP_status_codes). Some of the HTTP response codes are almost never used, like
...
the response code 402, [micropayments](https://en.wikipedia.org/wiki/Micropayment) have
...
* A socket has a *protocol*, which describes the steps by which
  ...
  something called [QUIC](https://en.wikipedia.org/wiki/QUIC)
...
sockets](https://en.wikipedia.org/wiki/Berkeley_sockets)” API design for 4.2 BSD Unix in 1983. Of course, Windows and
Linux merely reimplement the API, but macOS and iOS actually do [still
use](https://developer.apple.com/library/archive/documentation/Darwin/Conceptual/KernelProgramming/BSD/BSD.html) large amounts of code descended from BSD Unix.
...
normalize them to lower case.I used [`casefold`](https://docs.python.org/3/library/stdtypes.html#str.casefold)
...
The usual way to get the sent data, then, is everything after the
headers:
...
The [`Content-Encoding`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Encoding)
...
header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Accept-Encoding) in its request to list the compression algorithms it
supports. [`Transfer-Encoding`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Transfer-Encoding)
...
print out the text of the [browser.engineering](https://browser.engineering/) website.
...
![Figure 5: The difference between HTTP and HTTPS is the addition of a TLS layer.](https://browser.engineering/im/http-tls-2.gif)
...
a program called “Install Certificates”](https://stackoverflow.com/questions/52805115/certificate-verify-failed-unable-to-get-local-issuer-certificate) before you can use Python’s
...
TLS is pretty complicated. You can read the details in [RFC 8446](https://tools.ietf.org/html/rfc8446), but
...
Here is what it should output for [a simple example](https://browser.engineering/examples/example1-simple.html):
...
[Close](https://browser.engineering/http.html)
...
back to this page, and its [/redirect2](http://browser.engineering/redirect2) and [/redirect3](http://browser.engineering/redirect3) cousins which
...
the browser [informs
the server](https://developer.mozilla.org/en-US/docs/Web/HTTP/Content_negotiation) that compressed data is acceptable. Your browser must
...
send compressed data in a `Transfer-Encoding` called [`chunked`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Transfer-Encoding).There are also a couple of
`Transfer-Encoding`s that compress the data. They aren’t
