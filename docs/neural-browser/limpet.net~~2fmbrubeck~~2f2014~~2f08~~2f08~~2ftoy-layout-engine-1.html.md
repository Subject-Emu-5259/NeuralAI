...
I’m building a toy HTML rendering engine, and I think you should too. This is
...
simpler rendering engines like [Servo](https://github.com/servo/servo/) and [WeasyPrint](http://weasyprint.org/) are each
...
My own toy project, [robinson](https://github.com/mbrubeck/robinson), is written in [Rust](http://www.rust-lang.org/). I’m part
...
structures for the [DOM](http://dom.spec.whatwg.org/ "Document Object Model"). Let’s look at robinson’s [dom module](https://github.com/mbrubeck/robinson/blob/master/src/dom.rs).
...
There are several [node types](http://dom.spec.whatwg.org/#dom-node-nodetype), but for now we will ignore most of them
...
1. Start a new program in the language of your choice, and write code to
   represent a tree of DOM text nodes and elements.
2. Install the latest version of [Rust](http://www.rust-lang.org/), then download and build
   [robinson](https://github.com/mbrubeck/robinson). Open up `dom.rs` and extend `NodeType` to include
   additional types like comment nodes.
3. Write code to pretty-print a tree of DOM nodes.

In the [next article](https://limpet.net/mbrubeck/2014/08/11/toy-layout-engine-2.html), we’ll add a parser that turns HTML source
...
Garsiel’s wonderful [How Browsers Work](http://www.html5rocks.com/en/tutorials/internals/howbrowserswork/) and its links to further
resources.
...
You may find these useful for inspiration or reference. If you know of any
