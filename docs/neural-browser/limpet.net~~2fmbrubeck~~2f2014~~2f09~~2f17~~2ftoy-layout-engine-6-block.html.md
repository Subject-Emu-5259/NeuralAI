...
To keep things simple, this code implements only [normal flow](http://www.w3.org/TR/CSS2/visuren.html#positioning-scheme):
...
This uses a helper function called [`lookup`](https://github.com/mbrubeck/robinson/blob/bd5ea404201a4e4e29f90e222b500f10172fdcf8/src/style.rs#L33-L38), which just tries a
...
properties](http://www.w3.org/TR/CSS2/about.html#shorthand) and initial values.
...
[constraints](http://www.w3.org/TR/CSS2/visudet.html#blockwidth) and an algorithm for solving them. The
following code implements that algorithm.

First we add up the margin, padding, border, and content widths. The
[`to_px`](https://github.com/mbrubeck/robinson/blob/bd5ea404201a4e4e29f90e222b500f10172fdcf8/src/css.rs#L73-L80) helper method converts lengths to their numerical values. If
...
We now follow the spec’s [algorithm](http://www.w3.org/TR/CSS2/visudet.html#blockwidth) for eliminating any
...
margin may be [negative](http://www.smashingmagazine.com/2009/07/27/the-definitive-guide-to-using-negative-margins/) in the case of an overflow!)
...
converted to lengths. The results are the the [used values](http://www.w3.org/TR/CSS2/cascade.html#used-value) for
the horizontal box dimensions, which we will store in the layout tree. You
can see the final code in [layout.rs](https://github.com/mbrubeck/robinson/blob/bd5ea404201a4e4e29f90e222b500f10172fdcf8/src/layout.rs#L125-L210).
...
For simplicity, this does not implement [margin collapsing](http://www.w3.org/TR/CSS2/box.html#collapsing-margins).
...
*Update: [Part 7](https://limpet.net/mbrubeck/2014/11/05/toy-layout-engine-7-painting.html) is now ready.*
