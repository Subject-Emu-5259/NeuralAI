#!/usr/bin/env python3
"""Merge the NeuralAI v2 LoRA adapter into the base SmolLM2-360M-Instruct model
...
ADAPTER = "/home/workspace/Projects/NeuralAI/checkpoints/v2_model"
OUT = "/home/workspace/Projects/NeuralAI/checkpoints/v2_merged"
