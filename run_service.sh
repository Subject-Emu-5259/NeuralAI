...
# Llama.cpp/LM Studio serves the active Mamba model on :1234 (OpenAI-compatible).
...
# --- LM Studio ownership ---------------------------------------------------
# The dedicated `neuralai-lmstudio` watchdog service OWNS :1234.
...
#   1. Local OpenAI-compatible server on :1234 (LM Studio / llama.cpp)  [DEFAULT]
