...
MODELS = {
    "mamba-k1": {
        "id": "mamba-k1",
        "label": "Mamba K1 (130M, SFT v2)",
        "path": "/home/workspace/Projects/NeuralAI/models/mamba-k1/neuralai-mamba-k1.Q4_K_M.gguf",
        "params": "130M",
        "type": "mamba",
        "architecture": "Mamba SSM (state-spaces/mamba-130m-hf)",
        "training": "SFT LoRA on UltraChat (500 steps, 1K samples, intel format) — NeuralAI's first owned base model, being retrained for coherent chat",
