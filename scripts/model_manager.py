...
MODELS = {
    ...
    "mamba-k2": {
        "id": "mamba-k2",
        "label": "Mamba K2 (793M, SFT v1 queued)",
        ...
        "training": "SFT LoRA v1 on cleaned single-turn UltraChat (1K samples, intel format) via exports/k2-sft-gpu/Colab GPU; base downloaded from state-spaces/mamba-790m-hf",
        "runtime": "llama.cpp GGUF (Q4_K_M, 460MB) — target outputs checkpoints/k2-sft-v1",
        "ownership": "NeuralAI - In Training",
        "status": "awaiting_gpu",
        "chat_format": "neuralai-intel",
        "inference_note": "Base-only K2 produces non-chat completions. The live web-ui service is temporarily using an OpenRouter free-model fallback so chat remains usable while K2 SFT completes.",
        "interaction_mode": "chat",
    },
    "mamba-k3": {
        "id": "mamba-k3",
